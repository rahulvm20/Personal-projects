...
np.interp((abs(mv_nt),abs(mv_nt).min(),abs(mv_nt).max()),(1,15))


# In[ ]:


f = np.array([complex(1,2),complex(1,32),complex(1,32),complex(1,4)])


# In[ ]:


np.interp(abs(f),(abs(f).min(),abs(f).max()),(1,15)).astype(int)


# In[ ]:


np.vstack([[1,2,3],[1,2,3]])[0]
